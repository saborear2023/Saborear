...
public class NutrientesGuiaView extends ArrayAdapter<classeNutricional> {

    private final Activity context;
    private final ArrayList<classeNutricional> nutrientes;
    private final Database db;

    public NutrientesGuiaView(Activity context, ArrayList<classeNutricional> nutrientes) {

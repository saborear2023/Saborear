...
public class Contato extends AppCompatActivity {
    ...
    public void initialize() {
        voltar = findViewById(R.id.contato_btn_voltar);
        home = findViewById(R.id.contato_btn_home);
        pesquisar = findViewById(R.id.contato_btn_pesquisar);
        perfil = findViewById(R.id.contato_btn_perfil);
        notificacao = findViewById(R.id.contato_btn_notificacao);
        back = findViewById(R.id.contato_btn_back);

        ArrayList<View> ignore = new ArrayList<>();
        ArrayList<View> inverted = new ArrayList<>();
        ignore.add(findViewById(R.id.contato_txt_email)); ignore.add(findViewById(R.id.contato_txt_insta));
        ignore.add(findViewById(R.id.contato_icon_email)); ignore.add(findViewById(R.id.contato_icon_insta));
        Utils.blackMode(findViewById(R.id.contato_layout), ignore, inverted);
    }
